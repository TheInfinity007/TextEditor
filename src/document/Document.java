...
//		}
//		
//		if(syllables > 1 && word.charAt(word.length()-1) == 'e' && lastToken.equals("e")) {
//			syllables--;
//		}
//
//		return syllables;
	...
	{
		double words, syllables, sentences;
		syllables = (double)getNumSyllables();
		words = (double)getNumWords();
		sentences = (double)getNumSentences();
		double res = 206.835 - 1.015*(words/sentences) - 84.6*(syllables/words);
		double finalValue = (float)Math.round(res*10.0)/10.0;
